...
== Changelog ==
= 0.2.0 = 
* Fixed: Remove unwanted/unnecessary styling.,[github wppompey pompey-chart issues 1] 
* Changed: Start adding colours for ct-legend ct-series-5 onwards.,[github wppompey pompey-chart issues 1]
* Added: Generic [chart] shortcode,[github wppompey pompey-chart issues 4]
* Added: Support horizontal bar chart.,[github wppompey pompey-chart issues 4] 
* Added: Add class parameter to [chart] shortcode.,[github wppompey pompey-chart issues 4]
* Added: Support stacked Bars ( stackBars attr ),[github wppompey pompey-chart issues 4]
* Added: add tooltips attr - default false,[github wppompey pompey-chart issues 4]
* Added: Add Pie chart,[github wppompey pompey-chart issues 4]

= 0.1.0 =
* Changed: Enqueues scripts and CSS from local files,[github wppompey pompey-chart issues 1]
* Changed: Supports multiple uses of the [pompey_chart] shortcode,[github wppompey pompey-chart issues 3]
